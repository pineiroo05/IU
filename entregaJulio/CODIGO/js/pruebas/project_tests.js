...
let project_pruebas = Array(
    ...
    Array('project', 'end_date_project', 39, 74, 'ADD', [{end_date_project: '01/01/2026', start_date_project: '10/10/2026'}], 'fecha_fin_menor_inicio_KO'),
    ...
    Array('project', 'end_date_project', 44, 81, 'EDIT', [{end_date_project: '01/01/2026', start_date_project: '10/10/2026'}], 'fecha_fin_menor_inicio_KO'),
    ...
    Array('project', 'responsable_project', 51, 97, 'ADD', [{responsable_project: 'Jose_Gomez'}], 'responsable_project_format_KO'),
    Array('project', 'responsable_project', 51, 98, 'ADD', [{responsable_project: 'Jose-Maria'}], 'responsable_project_format_KO'),
    Array('project', 'responsable_project', 52, 99, 'ADD', [{responsable_project: 'Ramón Núñez de la Vega'}], true),

    Array('project', 'responsable_project', 53, 100, 'EDIT', [{responsable_project: 'Jose'}], 'responsable_project_min_size_KO'),
    Array('project', 'responsable_project', 54, 101, 'EDIT', [{responsable_project: 'a'.repeat(61)}], 'responsable_project_max_size_KO'),
    Array('project', 'responsable_project', 55, 102, 'EDIT', [{responsable_project: 'Jose 123'}], 'responsable_project_format_KO'),
    Array('project', 'responsable_project', 55, 103, 'EDIT', [{responsable_project: 'Jose_Gomez'}], 'responsable_project_format_KO'),
    Array('project', 'responsable_project', 55, 104, 'EDIT', [{responsable_project: 'Jose-Maria'}], 'responsable_project_format_KO'),
    Array('project', 'responsable_project', 56, 105, 'EDIT', [{responsable_project: 'Ramón Núñez de la Vega'}], true),

    Array('project', 'responsable_project', 57, 106, 'SEARCH', [{responsable_project: 'a'.repeat(61)}], 'responsable_project_max_size_KO'),
    Array('project', 'responsable_project', 58, 107, 'SEARCH', [{responsable_project: '1'}], 'responsable_project_format_KO'),
    Array('project', 'responsable_project', 58, 108, 'SEARCH', [{responsable_project: '_'}], 'responsable_project_format_KO'),
    ...
    Array('project', 'responsable_project', 58, 112, 'SEARCH', [{responsable_project: '@'}], 'responsable_project_format_KO'),
    Array('project', 'responsable_project', 59, 113, 'SEARCH', [{responsable_project: ''}], true),
    Array('project', 'responsable_project', 59, 114, 'SEARCH', [{responsable_project: 'Ramón'}], true),
    Array('project', 'responsable_project', 59, 115, 'SEARCH', [{responsable_project: 'Núñez'}], true),

    //organization_project
    Array('project', 'organization_project', 60, 116, 'ADD', [{organization_project: 'Jose'}], 'organization_project_min_size_KO'),
    Array('project', 'organization_project', 61, 117, 'ADD', [{organization_project: 'a'.repeat(101)}], 'organization_project_max_size_KO'),
    Array('project', 'organization_project', 62, 118, 'ADD', [{organization_project: 'aaaaaa 123'}], 'organization_project_format_KO'),
    Array('project', 'organization_project', 62, 119, 'ADD', [{organization_project: 'aaaaaa_aa'}], 'organization_project_format_KO'),
    Array('project', 'organization_project', 62, 120, 'ADD', [{organization_project: 'aaaaaa-aa'}], 'organization_project_format_KO'),
    Array('project', 'organization_project', 63, 121, 'ADD', [{organization_project: 'Organizacion del proyecto'}], true),

    Array('project', 'organization_project', 64, 122, 'EDIT', [{organization_project: 'Jose'}], 'organization_project_min_size_KO'),
    Array('project', 'organization_project', 65, 123, 'EDIT', [{organization_project: 'a'.repeat(101)}], 'organization_project_max_size_KO'),
    Array('project', 'organization_project', 66, 124, 'EDIT', [{organization_project: 'aaaaaa 123'}], 'organization_project_format_KO'),
    Array('project', 'organization_project', 66, 125, 'EDIT', [{organization_project: 'aaaaaa_aa'}], 'organization_project_format_KO'),
    Array('project', 'organization_project', 66, 126, 'EDIT', [{organization_project: 'aaaaaa-aa'}], 'organization_project_format_KO'),
    Array('project', 'organization_project', 67, 127, 'EDIT', [{organization_project: 'Organizacion del proyecto'}], true),

    Array('project', 'organization_project', 68, 128, 'SEARCH', [{organization_project: 'a'.repeat(101)}], 'organization_project_max_size_KO'),
    Array('project', 'organization_project', 69, 129, 'SEARCH', [{organization_project: '1'}], 'organization_project_format_KO'),
    Array('project', 'organization_project', 69, 130, 'SEARCH', [{organization_project: '_'}], 'organization_project_format_KO'),
    Array('project', 'organization_project', 69, 131, 'SEARCH', [{organization_project: 'aaaaaa 123'}], 'organization_project_format_KO'),
    Array('project', 'organization_project', 69, 132, 'SEARCH', [{organization_project: 'aaaaaa_aa'}], 'organization_project_format_KO'),
    Array('project', 'organization_project', 69, 133, 'SEARCH', [{organization_project: 'aaaaaa-aa'}], 'organization_project_format_KO'),
    Array('project', 'organization_project', 70, 134, 'SEARCH', [{organization_project: ''}], true),
    Array('project', 'organization_project', 70, 135, 'SEARCH', [{organization_project: 'Ramón'}], true),
    Array('project', 'organization_project', 70, 136, 'SEARCH', [{organization_project: 'Núñez'}], true),

    //description_project
    Array('project', 'description_project', 71, 137, 'ADD', [{description_project: 'Descripción muy corta'}], 'description_project_min_size_KO'),
    Array('project', 'description_project', 72, 138, 'ADD', [{description_project: 'a'.repeat(501)}], 'description_project_max_size_KO'),
    Array('project', 'description_project', 73, 139, 'ADD', [{description_project: 'Esta es una descripción válida que supera los treinta caracteres obligatorios.'}], true),

    Array('project', 'description_project', 74, 140, 'EDIT', [{description_project: 'Corta'}], 'description_project_min_size_KO'),
    Array('project', 'description_project', 75, 141, 'EDIT', [{description_project: 'a'.repeat(501)}], 'description_project_max_size_KO'),
    Array('project', 'description_project', 76, 142, 'EDIT', [{description_project: 'Descripción editada correctamente para pasar el test de validación.'}], true),

    Array('project', 'description_project', 77, 143, 'SEARCH', [{description_project: 'a'.repeat(501)}], 'description_project_max_size_KO'),
    Array('project', 'description_project', 78, 144, 'SEARCH', [{description_project: ''}], true),
    Array('project', 'description_project', 78, 145, 'SEARCH', [{description_project: 'Proyecto'}], true),
    Array('project', 'description_project', 78, 147, 'SEARCH', [{description_project: 'Validación'}], true),

    //file_project
    Array('project', 'file_project', 79, 148, 'SEARCH', [{file_project: 'a'.repeat(101)}], 'file_project_max_size_KO'),
    Array('project', 'file_project', 80, 149, 'SEARCH', [{file_project: 'archivo ñ.pdf'}], 'file_project_format_KO'),
    Array('project', 'file_project', 80, 150, 'SEARCH', [{file_project: 'archivo á.pdf'}], 'file_project_format_KO'),
    Array('project', 'file_project', 80, 151, 'SEARCH', [{file_project: 'archivo 1.pdf'}], 'file_project_format_KO'),
    Array('project', 'file_project', 80, 152, 'SEARCH', [{file_project: 'archivo_pdf'}], 'file_project_format_KO'),
    Array('project', 'file_project', 80, 153, 'SEARCH', [{file_project: ' '}], 'file_project_format_KO'),
    Array('project', 'file_project', 80, 154, 'SEARCH', [{file_project: '-'}], 'file_project_format_KO'),
    Array('project', 'file_project', 81, 155, 'SEARCH', [{file_project: ''}], true),
    Array('project', 'file_project', 81, 156, 'SEARCH', [{file_project: 'manual.pdf'}], true),
    Array('project', 'file_project', 81, 157, 'SEARCH', [{file_project: 'doc'}], true),

    //nuevo_file_project
    Array('project', 'nuevo_file_project', 82, 158, 'ADD', [{nuevo_file_project:{max_size_file:'', type_file:'', format_name_file:''}}], 'nuevo_file_project_not_exist_file_KO'),
    Array('project', 'nuevo_file_project', 83, 159, 'ADD', [{nuevo_file_project:{max_size_file: 20000000,type_file:'application/pdf', format_name_file:'documento.pdf'}}], 'nuevo_file_project_max_size_file_KO'),
    Array('project', 'nuevo_file_project', 84, 160, 'ADD', [{nuevo_file_project:{max_size_file: 2000000,type_file:'image/png', format_name_file:'imagen.png'}}], 'nuevo_file_project_type_file_KO'),
    Array('project', 'nuevo_file_project', 85, 161, 'ADD', [{nuevo_file_project:{max_size_file: 2000000,type_file:'application/pdf', format_name_file:'documentó.pdf'}}], 'nuevo_file_project_format_name_file_KO'),
    Array('project', 'nuevo_file_project', 85, 162, 'ADD', [{nuevo_file_project:{max_size_file: 2000000,type_file:'application/pdf', format_name_file:'documeñto.pdf'}}], 'nuevo_file_project_format_name_file_KO'),
    Array('project', 'nuevo_file_project', 85, 163, 'ADD', [{nuevo_file_project:{max_size_file: 2000000,type_file:'application/pdf', format_name_file:'docume nto.pdf'}}], 'nuevo_file_project_format_name_file_KO'),
    Array('project', 'nuevo_file_project', 86, 164, 'ADD', [{nuevo_file_project:{max_size_file: 2000000,type_file:'application/pdf', format_name_file:'do.pdf'}}], 'nuevo_file_project_min_file_name_size_KO'),
    Array('project', 'nuevo_file_project', 87, 165, 'ADD', [{nuevo_file_project:{max_size_file: 2000000,type_file:'application/pdf', format_name_file:'d'.repeat(100)+'.pdf'}}], 'nuevo_file_project_max_file_name_size_KO'),
    Array('project', 'nuevo_file_project', 88, 166, 'ADD', [{nuevo_file_project:{max_size_file: 2000000,type_file:'application/pdf', format_name_file:'documento.pdf'}}], true),

    Array('project', 'nuevo_file_project', 89, 167, 'EDIT', [{nuevo_file_project:{max_size_file: 20000000,type_file:'application/pdf', format_name_file:'documento.pdf'}}], 'nuevo_file_project_max_size_file_KO'),
    Array('project', 'nuevo_file_project', 90, 168, 'EDIT', [{nuevo_file_project:{max_size_file: 2000000,type_file:'image/png', format_name_file:'imagen.png'}}], 'nuevo_file_project_type_file_KO'),
    Array('project', 'nuevo_file_project', 91, 169, 'EDIT', [{nuevo_file_project:{max_size_file: 2000000,type_file:'application/pdf', format_name_file:'documentó.pdf'}}], 'nuevo_file_project_format_name_file_KO'),
    Array('project', 'nuevo_file_project', 91, 170, 'EDIT', [{nuevo_file_project:{max_size_file: 2000000,type_file:'application/pdf', format_name_file:'documeñto.pdf'}}], 'nuevo_file_project_format_name_file_KO'),
    Array('project', 'nuevo_file_project', 91, 171, 'EDIT', [{nuevo_file_project:{max_size_file: 2000000,type_file:'application/pdf', format_name_file:'docume nto.pdf'}}], 'nuevo_file_project_format_name_file_KO'),
    Array('project', 'nuevo_file_project', 92, 172, 'EDIT', [{nuevo_file_project:{max_size_file: 2000000,type_file:'application/pdf', format_name_file:'do.pdf'}}], 'nuevo_file_project_min_file_name_size_KO'),
    Array('project', 'nuevo_file_project', 93, 173, 'EDIT', [{nuevo_file_project:{max_size_file: 2000000,type_file:'application/pdf', format_name_file:'d'.repeat(100)+'.pdf'}}], 'nuevo_file_project_max_file_name_size_KO'),
    Array('project', 'nuevo_file_project', 94, 174, 'EDIT', [{nuevo_file_project:{max_size_file: 2000000,type_file:'application/pdf', format_name_file:'documento.pdf'}}], true),


    //code_project
    Array('project', 'code_project', 95, 175, 'ADD', [{code_project: 'ABC'}], 'code_project_min_size_KO'),
    Array('project', 'code_project', 96, 176, 'ADD', [{code_project: 'a'.repeat(51)}], 'code_project_max_size_KO'),
    Array('project', 'code_project', 97, 177, 'ADD', [{code_project: 'CÓDIGO-01'}], 'code_project_format_KO'), // Error por acento
    Array('project', 'code_project', 97, 178, 'ADD', [{code_project: 'PROY 123'}], 'code_project_format_KO'),  // Error por número
    Array('project', 'code_project', 97, 179, 'ADD', [{code_project: 'PROY_Á_99'}], 'code_project_format_KO'), // Mixto
    Array('project', 'code_project', 98, 180, 'ADD', [{code_project: 'PROY.Ñ-TEST.ESP'}], true),

    Array('project', 'code_project', 99, 181, 'EDIT', [{code_project: 'ABC'}], 'code_project_min_size_KO'),
    Array('project', 'code_project', 100, 182, 'EDIT', [{code_project: 'a'.repeat(51)}], 'code_project_max_size_KO'),
    Array('project', 'code_project', 101, 183, 'EDIT', [{code_project: 'ACCIÓN'}], 'code_project_format_KO'),
    Array('project', 'code_project', 101, 184, 'EDIT', [{code_project: 'CODE_001'}], 'code_project_format_KO'),
    Array('project', 'code_project', 101, 185, 'EDIT', [{code_project: 'CODE+TEST'}], 'code_project_format_KO'),
    Array('project', 'code_project', 102, 186, 'EDIT', [{code_project: 'PRUEBA.Ñ.FINAL'}], true),

    Array('project', 'code_project', 103, 187, 'SEARCH', [{code_project: 'a'.repeat(51)}], 'code_project_max_size_KO'),
    Array('project', 'code_project', 104, 188, 'SEARCH', [{code_project: 'á'}], 'code_project_format_KO'),
    Array('project', 'code_project', 104, 189, 'SEARCH', [{code_project: '1'}], 'code_project_format_KO'),
    ...
    Array('project', 'code_project', 104, 192, 'SEARCH', [{code_project: '/'}], 'code_project_format_KO'),
    Array('project', 'code_project', 104, 193, 'SEARCH', [{code_project: '='}], 'code_project_format_KO'),
    Array('project', 'code_project', 105, 194, 'SEARCH', [{code_project: ''}], true),
    Array('project', 'code_project', 105, 195, 'SEARCH', [{code_project: 'PROY'}], true),
    Array('project', 'code_project', 105, 196, 'SEARCH', [{code_project: 'TEST.Ñ'}], true),

    //acronym_project
    Array('project', 'acronym_project', 106, 197, 'ADD', [{acronym_project: 'ABC'}], 'acronym_project_min_size_KO'),
    Array('project', 'acronym_project', 107, 198, 'ADD', [{acronym_project: 'A'.repeat(16)}], 'acronym_project_max_size_KO'),
    Array('project', 'acronym_project', 108, 199, 'ADD', [{acronym_project: 'AAAAAAÁ'}], 'acronym_project_format_KO'),
    Array('project', 'acronym_project', 108, 200, 'ADD', [{acronym_project: 'AAAAAA1'}], 'acronym_project_format_KO'),
    Array('project', 'acronym_project', 108, 201, 'ADD', [{acronym_project: 'AAAAAA A'}], 'acronym_project_format_KO'),
    Array('project', 'acronym_project', 109, 202, 'ADD', [{acronym_project: 'PROY.Ñ-'}], true),

    Array('project', 'acronym_project', 110, 203, 'EDIT', [{acronym_project: 'ABC'}], 'acronym_project_min_size_KO'),
    Array('project', 'acronym_project', 111, 204, 'EDIT', [{acronym_project: 'A'.repeat(16)}], 'acronym_project_max_size_KO'),
    Array('project', 'acronym_project', 112, 205, 'EDIT', [{acronym_project: 'AAAAAAÁ'}], 'acronym_project_format_KO'),
    Array('project', 'acronym_project', 112, 206, 'EDIT', [{acronym_project: 'AAAAAA1'}], 'acronym_project_format_KO'),
    Array('project', 'acronym_project', 112, 207, 'EDIT', [{acronym_project: 'AAAAAA A'}], 'acronym_project_format_KO'),
    Array('project', 'acronym_project', 113, 208, 'EDIT', [{acronym_project: 'PROY.Ñ-'}], true),

    Array('project', 'acronym_project', 114, 209, 'SEARCH', [{acronym_project: 'A'.repeat(16)}], 'acronym_project_max_size_KO'),
    Array('project', 'acronym_project', 115, 210, 'SEARCH', [{acronym_project: 'Á'}], 'acronym_project_format_KO'),
    Array('project', 'acronym_project', 115, 211, 'SEARCH', [{acronym_project: '1'}], 'acronym_project_format_KO'),
    Array('project', 'acronym_project', 115, 212, 'SEARCH', [{acronym_project: 'A a'}], 'acronym_project_format_KO'),
    Array('project', 'acronym_project', 115, 213, 'SEARCH', [{acronym_project: 'AAAAAAÁ'}], 'acronym_project_format_KO'),
    Array('project', 'acronym_project', 115, 214, 'SEARCH', [{acronym_project: 'AAAAAA1'}], 'acronym_project_format_KO'),
    Array('project', 'acronym_project', 115, 215, 'SEARCH', [{acronym_project: 'AAAAAA A'}], 'acronym_project_format_KO'),
    Array('project', 'acronym_project', 116, 216, 'SEARCH', [{acronym_project: ''}], true),
    Array('project', 'acronym_project', 116, 217, 'SEARCH', [{acronym_project: 'PRO'}], true),
    Array('project', 'acronym_project', 116, 218, 'SEARCH', [{acronym_project: 'PROY.Ñ-'}], true),

    //id_sampling_methodology
    Array('project', 'id_sampling_methodology', 117, 219, 'ADD', [{id_sampling_methodology: ''}], 'id_sampling_methodology_min_size_KO'),
    Array('project', 'id_sampling_methodology', 118, 220, 'ADD', [{id_sampling_methodology: '123456789012'}], 'id_sampling_methodology_max_size_KO'),
    Array('project', 'id_sampling_methodology', 119, 221, 'ADD', [{id_sampling_methodology: 'abc'}], 'id_sampling_methodology_format_KO'),
    Array('project', 'id_sampling_methodology', 119, 222, 'ADD', [{id_sampling_methodology: '12.3'}], 'id_sampling_methodology_format_KO'),
    Array('project', 'id_sampling_methodology', 119, 223, 'ADD', [{id_sampling_methodology: '12-3'}], 'id_sampling_methodology_format_KO'),
    Array('project', 'id_sampling_methodology', 120, 224, 'ADD', [{id_sampling_methodology: '77'}], true),

    Array('project', 'id_sampling_methodology', 121, 225, 'EDIT', [{id_sampling_methodology: ''}], 'id_sampling_methodology_min_size_KO'),
    Array('project', 'id_sampling_methodology', 122, 226, 'EDIT', [{id_sampling_methodology: '123456789012'}], 'id_sampling_methodology_max_size_KO'),
    Array('project', 'id_sampling_methodology', 123, 227, 'EDIT', [{id_sampling_methodology: 'abc'}], 'id_sampling_methodology_format_KO'),
    Array('project', 'id_sampling_methodology', 123, 228, 'EDIT', [{id_sampling_methodology: ' '}], 'id_sampling_methodology_format_KO'),
    Array('project', 'id_sampling_methodology', 123, 229, 'EDIT', [{id_sampling_methodology: '@'}], 'id_sampling_methodology_format_KO'),
    Array('project', 'id_sampling_methodology', 124, 230, 'EDIT', [{id_sampling_methodology: '88'}], true),

    Array('project', 'id_sampling_methodology', 125, 231, 'SEARCH', [{id_sampling_methodology: '123456789012'}], 'id_sampling_methodology_max_size_KO'),
    Array('project', 'id_sampling_methodology', 126, 232, 'SEARCH', [{id_sampling_methodology: 'abc'}], 'id_sampling_methodology_format_KO'),
    Array('project', 'id_sampling_methodology', 126, 233, 'SEARCH', [{id_sampling_methodology: '-'}], 'id_sampling_methodology_format_KO'),
    Array('project', 'id_sampling_methodology', 126, 234, 'SEARCH', [{id_sampling_methodology: '.'}], 'id_sampling_methodology_format_KO'),
    Array('project', 'id_sampling_methodology', 126, 235, 'SEARCH', [{id_sampling_methodology: ' '}], 'id_sampling_methodology_format_KO'),
    Array('project', 'id_sampling_methodology', 126, 236, 'SEARCH', [{id_sampling_methodology: '1_'}], 'id_sampling_methodology_format_KO'),
    Array('project', 'id_sampling_methodology', 126, 237, 'SEARCH', [{id_sampling_methodology: '!!'}], 'id_sampling_methodology_format_KO'),
    Array('project', 'id_sampling_methodology', 127, 238, 'SEARCH', [{id_sampling_methodology: ''}], true),
    Array('project', 'id_sampling_methodology', 127, 239, 'SEARCH', [{id_sampling_methodology: '1'}], true),
    Array('project', 'id_sampling_methodology', 127, 240, 'SEARCH', [{id_sampling_methodology: '99'}], true)
);