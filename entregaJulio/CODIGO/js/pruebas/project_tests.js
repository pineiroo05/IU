...
let project_pruebas = Array(
    ...
    //file_project
    Array('project', 'file_project', 79, 121, 'SEARCH', [{file_project: 'a'.repeat(101)}], 'file_project_max_size_KO'),
    ...
    Array('project', 'nuevo_file_project', 84, 133, 'ADD', [{nuevo_file_project:{max_size_file: 2000000,type_file:'image/png', format_name_file:'imagen.png'}}], 'nuevo_file_project_type_file_KO'),
    ...
    Array('project', 'nuevo_file_project', 85, 136, 'ADD', [{nuevo_file_project:{max_size_file: 2000000,type_file:'application/pdf', format_name_file:'docume nto.pdf'}}], 'nuevo_file_project_format_name_file_KO'),
    Array('project', 'nuevo_file_project', 86, 137, 'ADD', [{nuevo_file_project:{max_size_file: 2000000,type_file:'application/pdf', format_name_file:'do.pdf'}}], 'nuevo_file_project_min_file_name_size_KO'),
    Array('project', 'nuevo_file_project', 87, 138, 'ADD', [{nuevo_file_project:{max_size_file: 2000000,type_file:'application/pdf', format_name_file:'d'.repeat(100)+'.pdf'}}], 'nuevo_file_project_max_file_name_size_KO'),
    ...
    Array('project', 'nuevo_file_project', 90, 141, 'EDIT', [{nuevo_file_project:{max_size_file: 2000000,type_file:'image/png', format_name_file:'imagen.png'}}], 'nuevo_file_project_type_file_KO'),
    ...
    Array('project', 'nuevo_file_project', 91, 144, 'EDIT', [{nuevo_file_project:{max_size_file: 2000000,type_file:'application/pdf', format_name_file:'docume nto.pdf'}}], 'nuevo_file_project_format_name_file_KO'),
    Array('project', 'nuevo_file_project', 92, 145, 'EDIT', [{nuevo_file_project:{max_size_file: 2000000,type_file:'application/pdf', format_name_file:'do.pdf'}}], 'nuevo_file_project_min_file_name_size_KO'),
    Array('project', 'nuevo_file_project', 93, 146, 'EDIT', [{nuevo_file_project:{max_size_file: 2000000,type_file:'application/pdf', format_name_file:'d'.repeat(100)+'.pdf'}}], 'nuevo_file_project_max_file_name_size_KO'),
    ...
    Array('project', 'acronym_project', 109, 175, 'ADD', [{acronym_project: 'PROY.Ñ-'}], true),
    ...
    Array('project', 'acronym_project', 113, 181, 'EDIT', [{acronym_project: 'PROY.Ñ-'}], true),

    Array('project', 'acronym_project', 114, 182, 'SEARCH', [{acronym_project: 'A'.repeat(16)}], 'acronym_project_max_size_KO'),
    Array('project', 'acronym_project', 115, 183, 'SEARCH', [{acronym_project: 'Á'}], 'acronym_project_format_KO'),
    Array('project', 'acronym_project', 115, 184, 'SEARCH', [{acronym_project: '1'}], 'acronym_project_format_KO'),
    Array('project', 'acronym_project', 115, 185, 'SEARCH', [{acronym_project: 'A a'}], 'acronym_project_format_KO'),
    Array('project', 'acronym_project', 115, 186, 'SEARCH', [{acronym_project: 'AAAAAAÁ'}], 'acronym_project_format_KO'),
    Array('project', 'acronym_project', 115, 187, 'SEARCH', [{acronym_project: 'AAAAAA1'}], 'acronym_project_format_KO'),
    Array('project', 'acronym_project', 115, 188, 'SEARCH', [{acronym_project: 'AAAAAA A'}], 'acronym_project_format_KO'),
    Array('project', 'acronym_project', 116, 189, 'SEARCH', [{acronym_project: ''}], true),
    Array('project', 'acronym_project', 116, 190, 'SEARCH', [{acronym_project: 'PRO'}], true),
    Array('project', 'acronym_project', 116, 191, 'SEARCH', [{acronym_project: 'PROY.Ñ-'}], true),

    //id_sampling_methodology
    Array('project', 'id_sampling_methodology', 117, 192, 'ADD', [{id_sampling_methodology: ''}], 'id_sampling_methodology_min_size_KO'),
    Array('project', 'id_sampling_methodology', 118, 193, 'ADD', [{id_sampling_methodology: '123456789012'}], 'id_sampling_methodology_max_size_KO'),
    Array('project', 'id_sampling_methodology', 119, 194, 'ADD', [{id_sampling_methodology: 'abc'}], 'id_sampling_methodology_format_KO'),
    Array('project', 'id_sampling_methodology', 119, 195, 'ADD', [{id_sampling_methodology: '12.3'}], 'id_sampling_methodology_format_KO'),
    Array('project', 'id_sampling_methodology', 119, 196, 'ADD', [{id_sampling_methodology: '12-3'}], 'id_sampling_methodology_format_KO'),
    Array('project', 'id_sampling_methodology', 120, 197, 'ADD', [{id_sampling_methodology: '77'}], true),

    Array('project', 'id_sampling_methodology', 121, 198, 'EDIT', [{id_sampling_methodology: ''}], 'id_sampling_methodology_min_size_KO'),
    Array('project', 'id_sampling_methodology', 122, 199, 'EDIT', [{id_sampling_methodology: '123456789012'}], 'id_sampling_methodology_max_size_KO'),
    Array('project', 'id_sampling_methodology', 123, 200, 'EDIT', [{id_sampling_methodology: 'abc'}], 'id_sampling_methodology_format_KO'),
    Array('project', 'id_sampling_methodology', 123, 201, 'EDIT', [{id_sampling_methodology: ' '}], 'id_sampling_methodology_format_KO'),
    Array('project', 'id_sampling_methodology', 123, 202, 'EDIT', [{id_sampling_methodology: '@'}], 'id_sampling_methodology_format_KO'),
    Array('project', 'id_sampling_methodology', 124, 203, 'EDIT', [{id_sampling_methodology: '88'}], true),

    Array('project', 'id_sampling_methodology', 125, 204, 'SEARCH', [{id_sampling_methodology: '123456789012'}], 'id_sampling_methodology_max_size_KO'),
    Array('project', 'id_sampling_methodology', 126, 205, 'SEARCH', [{id_sampling_methodology: 'abc'}], 'id_sampling_methodology_format_KO'),
    Array('project', 'id_sampling_methodology', 126, 206, 'SEARCH', [{id_sampling_methodology: '-'}], 'id_sampling_methodology_format_KO'),
    ...
    Array('project', 'id_sampling_methodology', 126, 209, 'SEARCH', [{id_sampling_methodology: '1_'}], 'id_sampling_methodology_format_KO'),
    Array('project', 'id_sampling_methodology', 126, 210, 'SEARCH', [{id_sampling_methodology: '!!'}], 'id_sampling_methodology_format_KO'),
    Array('project', 'id_sampling_methodology', 127, 211, 'SEARCH', [{id_sampling_methodology: ''}], true),
    Array('project', 'id_sampling_methodology', 127, 212, 'SEARCH', [{id_sampling_methodology: '1'}], true),
    Array('project', 'id_sampling_methodology', 127, 213, 'SEARCH', [{id_sampling_methodology: '99'}], true)
);