...
let analysis_preparation_pruebas = Array(
    ...
    // name_analysis_preparation
    Array('analysis_preparation', 'name_analysis_preparation', 12, 13, 'ADD', [{name_analysis_preparation: 'abc'}], 'name_analysis_preparation_min_size_KO'),
    Array('analysis_preparation', 'name_analysis_preparation', 13, 14, 'ADD', [{name_analysis_preparation: 'a'.repeat(101)}], 'name_analysis_preparation_max_size_KO'),
    Array('analysis_preparation', 'name_analysis_preparation', 14, 15, 'ADD', [{name_analysis_preparation: 'aaaaaaaaá'}], 'name_analysis_preparation_format_KO'),
    Array('analysis_preparation', 'name_analysis_preparation', 14, 16, 'ADD', [{name_analysis_preparation: 'aaaaaa_aa'}], 'name_analysis_preparation_format_KO'),
    Array('analysis_preparation', 'name_analysis_preparation', 14, 17, 'ADD', [{name_analysis_preparation: 'aaaaaaaañ'}], 'name_analysis_preparation_format_KO'),
    Array('analysis_preparation', 'name_analysis_preparation', 15, 18, 'ADD', [{name_analysis_preparation: 'nombreCorrecto'}], true),

    Array('analysis_preparation', 'name_analysis_preparation', 16, 19, 'EDIT', [{name_analysis_preparation: 'abc'}], 'name_analysis_preparation_min_size_KO'),
    Array('analysis_preparation', 'name_analysis_preparation', 17, 20, 'EDIT', [{name_analysis_preparation: 'a'.repeat(101)}], 'name_analysis_preparation_max_size_KO'),
    Array('analysis_preparation', 'name_analysis_preparation', 18, 21, 'EDIT', [{name_analysis_preparation: 'aaaaaaaaá'}], 'name_analysis_preparation_format_KO'),
    Array('analysis_preparation', 'name_analysis_preparation', 18, 22, 'EDIT', [{name_analysis_preparation: 'aaaaaa_aa'}], 'name_analysis_preparation_format_KO'),
    Array('analysis_preparation', 'name_analysis_preparation', 18, 23, 'EDIT', [{name_analysis_preparation: 'aaaaaaaañ'}], 'name_analysis_preparation_format_KO'),
    Array('analysis_preparation', 'name_analysis_preparation', 19, 24, 'EDIT', [{name_analysis_preparation: 'nombreCorrecto'}], true),

    Array('analysis_preparation', 'name_analysis_preparation', 20, 25, 'SEARCH', [{name_analysis_preparation: 'a'.repeat(101)}], 'name_analysis_preparation_max_size_KO'),
    Array('analysis_preparation', 'name_analysis_preparation', 21, 26, 'SEARCH', [{name_analysis_preparation: 'á'}], 'name_analysis_preparation_format_KO'),
    Array('analysis_preparation', 'name_analysis_preparation', 21, 27, 'SEARCH', [{name_analysis_preparation: 'a_a'}], 'name_analysis_preparation_format_KO'),
    Array('analysis_preparation', 'name_analysis_preparation', 21, 28, 'SEARCH', [{name_analysis_preparation: 'ñ'}], 'name_analysis_preparation_format_KO'),
    Array('analysis_preparation', 'name_analysis_preparation', 21, 29, 'SEARCH', [{name_analysis_preparation: 'aaaaaaaaá'}], 'name_analysis_preparation_format_KO'),
    Array('analysis_preparation', 'name_analysis_preparation', 21, 30, 'SEARCH', [{name_analysis_preparation: 'aaaaaa_aá'}], 'name_analysis_preparation_format_KO'),
    Array('analysis_preparation', 'name_analysis_preparation', 21, 31, 'SEARCH', [{name_analysis_preparation: 'aaaaaaaañ'}], 'name_analysis_preparation_format_KO'),
    ...
    Array('analysis_preparation', 'description_analysis_preparation', 26, 39, 'ADD', [{description_analysis_preparation: 'Esta es una descripcion correctaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa'}], true),
    ...
    Array('analysis_preparation', 'description_analysis_preparation', 30, 44, 'EDIT', [{description_analysis_preparation: 'Esta es una descripcion correctaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa'}], true),
    ...
    Array('analysis_preparation', 'description_analysis_preparation', 33, 52, 'SEARCH', [{description_analysis_preparation: 'Esta es una descripcion correctaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa'}], true),

    // bib_analysis_preparation
    Array('analysis_preparation', 'bib_analysis_preparation', 34, 53, 'ADD', [{bib_analysis_preparation: 'abc'}], 'bib_analysis_preparation_min_size_KO'),
    Array('analysis_preparation', 'bib_analysis_preparation', 35, 54, 'ADD', [{bib_analysis_preparation: 'a'.repeat(201)}], 'bib_analysis_preparation_max_size_KO'),
    Array('analysis_preparation', 'bib_analysis_preparation', 36, 55, 'ADD', [{bib_analysis_preparation: 'a'.repeat(16)+'1'}], 'bib_analysis_preparation_format_KO'),
    Array('analysis_preparation', 'bib_analysis_preparation', 36, 56, 'ADD', [{bib_analysis_preparation: 'a'.repeat(16)+'_'}], 'bib_analysis_preparation_format_KO'),
    Array('analysis_preparation', 'bib_analysis_preparation', 36, 57, 'ADD', [{bib_analysis_preparation: 'a'.repeat(16)+'-'}], 'bib_analysis_preparation_format_KO'),
    Array('analysis_preparation', 'bib_analysis_preparation', 36, 58, 'ADD', [{bib_analysis_preparation: 'a'.repeat(16)+'ç'}], 'bib_analysis_preparation_format_KO'),
    Array('analysis_preparation', 'bib_analysis_preparation', 37, 59, 'ADD', [{bib_analysis_preparation: 'Bibliografía con eñe, acentos y espacios'}], true),

    Array('analysis_preparation', 'bib_analysis_preparation', 38, 53, 'EDIT', [{bib_analysis_preparation: 'abc'}], 'bib_analysis_preparation_min_size_KO'),
    Array('analysis_preparation', 'bib_analysis_preparation', 39, 54, 'EDIT', [{bib_analysis_preparation: 'a'.repeat(201)}], 'bib_analysis_preparation_max_size_KO'),
    Array('analysis_preparation', 'bib_analysis_preparation', 40, 55, 'EDIT', [{bib_analysis_preparation: 'a'.repeat(16)+'1'}], 'bib_analysis_preparation_format_KO'),
    Array('analysis_preparation', 'bib_analysis_preparation', 40, 56, 'EDIT', [{bib_analysis_preparation: 'a'.repeat(16)+'_'}], 'bib_analysis_preparation_format_KO'),
    Array('analysis_preparation', 'bib_analysis_preparation', 40, 57, 'EDIT', [{bib_analysis_preparation: 'a'.repeat(16)+'-'}], 'bib_analysis_preparation_format_KO'),
    Array('analysis_preparation', 'bib_analysis_preparation', 40, 58, 'EDIT', [{bib_analysis_preparation: 'a'.repeat(16)+'ç'}], 'bib_analysis_preparation_format_KO'),
    Array('analysis_preparation', 'bib_analysis_preparation', 41, 59, 'EDIT', [{bib_analysis_preparation: 'Bibliografía con eñe, acentos y espacios'}], true),

    Array('analysis_preparation', 'bib_analysis_preparation', 42, 60, 'SEARCH', [{bib_analysis_preparation: 'a'.repeat(201)}], 'bib_analysis_preparation_max_size_KO'),
    Array('analysis_preparation', 'bib_analysis_preparation', 43, 61, 'SEARCH', [{bib_analysis_preparation: '1'}], 'bib_analysis_preparation_format_KO'),
    Array('analysis_preparation', 'bib_analysis_preparation', 43, 62, 'SEARCH', [{bib_analysis_preparation: '_'}], 'bib_analysis_preparation_format_KO'),
    Array('analysis_preparation', 'bib_analysis_preparation', 43, 63, 'SEARCH', [{bib_analysis_preparation: '-'}], 'bib_analysis_preparation_format_KO'),
    Array('analysis_preparation', 'bib_analysis_preparation', 43, 64, 'SEARCH', [{bib_analysis_preparation: 'ç'}], 'bib_analysis_preparation_format_KO'),
    Array('analysis_preparation', 'bib_analysis_preparation', 43, 65, 'SEARCH', [{bib_analysis_preparation: 'a'.repeat(16)+'1'}], 'bib_analysis_preparation_format_KO'),
    Array('analysis_preparation', 'bib_analysis_preparation', 43, 66, 'SEARCH', [{bib_analysis_preparation: 'a'.repeat(16)+'_'}], 'bib_analysis_preparation_format_KO'),
    Array('analysis_preparation', 'bib_analysis_preparation', 43, 67, 'SEARCH', [{bib_analysis_preparation: 'a'.repeat(16)+'-'}], 'bib_analysis_preparation_format_KO'),
    Array('analysis_preparation', 'bib_analysis_preparation', 43, 68, 'SEARCH', [{bib_analysis_preparation: 'a'.repeat(16)+'ç'}], 'bib_analysis_preparation_format_KO'),
    ...
    Array('analysis_preparation', 'bib_analysis_preparation', 44, 71, 'SEARCH', [{bib_analysis_preparation: 'Bibliografía con eñe, acentos y espacios'}], true),
    ...
    // nuevo_file_analysis_preparation
    Array('analysis_preparation', 'nuevo_file_analysis_preparation', 48, 81, 'ADD', [{nuevo_file_analysis_preparation:{max_size_file:'',type_file:'',format_name_file:''}}], 'nuevo_file_analysis_preparation_not_exist_file_KO'),
    Array('analysis_preparation', 'nuevo_file_analysis_preparation', 49, 81, 'ADD', [{nuevo_file_analysis_preparation:{max_size_file:20000000,type_file:'application/pdf',format_name_file:'documento.pdf'}}], 'nuevo_file_analysis_preparation_max_size_file_KO'),
    Array('analysis_preparation', 'nuevo_file_analysis_preparation', 50, 81, 'ADD', [{nuevo_file_analysis_preparation:{max_size_file:2000000 ,type_file:'image/png',format_name_file:'documento.pdf'}}], 'nuevo_file_analysis_preparation_type_file_KO'),
    Array('analysis_preparation', 'nuevo_file_analysis_preparation', 51, 81, 'ADD', [{nuevo_file_analysis_preparation:{max_size_file:2000000 ,type_file:'application/pdf',format_name_file:'documentó.pdf'}}], 'nuevo_file_analysis_preparation_format_name_file_KO'),
    Array('analysis_preparation', 'nuevo_file_analysis_preparation', 51, 81, 'ADD', [{nuevo_file_analysis_preparation:{max_size_file:2000000 ,type_file:'application/pdf',format_name_file:'documeñto.pdf'}}], 'nuevo_file_analysis_preparation_format_name_file_KO'),
    Array('analysis_preparation', 'nuevo_file_analysis_preparation', 51, 81, 'ADD', [{nuevo_file_analysis_preparation:{max_size_file:2000000 ,type_file:'application/pdf',format_name_file:'docume nto.pdf'}}], 'nuevo_file_analysis_preparation_format_name_file_KO'),
    Array('analysis_preparation', 'nuevo_file_analysis_preparation', 52, 81, 'ADD', [{nuevo_file_analysis_preparation:{max_size_file:2000000 ,type_file:'application/pdf',format_name_file:'do.pdf'}}], 'nuevo_file_analysis_preparation_min_file_name_size_KO'),
    Array('analysis_preparation', 'nuevo_file_analysis_preparation', 53, 81, 'ADD', [{nuevo_file_analysis_preparation:{max_size_file:2000000 ,type_file:'application/pdf',format_name_file:'a'.repeat(104)}}], 'nuevo_file_analysis_preparation_max_file_name_size_KO'),
    Array('analysis_preparation', 'nuevo_file_analysis_preparation', 54, 81, 'ADD', [{nuevo_file_analysis_preparation:{max_size_file:2000000 ,type_file:'application/pdf',format_name_file:'documento.pdf'}}], true),

    Array('analysis_preparation', 'nuevo_file_analysis_preparation', 55, 81, 'EDIT', [{nuevo_file_analysis_preparation:{max_size_file:20000000,type_file:'application/pdf',format_name_file:'documento.pdf'}}], 'nuevo_file_analysis_preparation_max_size_file_KO'),
    Array('analysis_preparation', 'nuevo_file_analysis_preparation', 56, 81, 'EDIT', [{nuevo_file_analysis_preparation:{max_size_file:2000000 ,type_file:'image/png',format_name_file:'documento.pdf'}}], 'nuevo_file_analysis_preparation_type_file_KO'),
    Array('analysis_preparation', 'nuevo_file_analysis_preparation', 57, 81, 'EDIT', [{nuevo_file_analysis_preparation:{max_size_file:2000000 ,type_file:'application/pdf',format_name_file:'documentó.pdf'}}], 'nuevo_file_analysis_preparation_format_name_file_KO'),
    Array('analysis_preparation', 'nuevo_file_analysis_preparation', 57, 81, 'EDIT', [{nuevo_file_analysis_preparation:{max_size_file:2000000 ,type_file:'application/pdf',format_name_file:'documeñto.pdf'}}], 'nuevo_file_analysis_preparation_format_name_file_KO'),
    Array('analysis_preparation', 'nuevo_file_analysis_preparation', 57, 81, 'EDIT', [{nuevo_file_analysis_preparation:{max_size_file:2000000 ,type_file:'application/pdf',format_name_file:'docume nto.pdf'}}], 'nuevo_file_analysis_preparation_format_name_file_KO'),
    Array('analysis_preparation', 'nuevo_file_analysis_preparation', 58, 81, 'EDIT', [{nuevo_file_analysis_preparation:{max_size_file:2000000 ,type_file:'application/pdf',format_name_file:'do.pdf'}}], 'nuevo_file_analysis_preparation_min_file_name_size_KO'),
    Array('analysis_preparation', 'nuevo_file_analysis_preparation', 59, 81, 'EDIT', [{nuevo_file_analysis_preparation:{max_size_file:2000000 ,type_file:'application/pdf',format_name_file:'a'.repeat(104)}}], 'nuevo_file_analysis_preparation_max_file_name_size_KO'),
    Array('analysis_preparation', 'nuevo_file_analysis_preparation', 60, 81, 'EDIT', [{nuevo_file_analysis_preparation:{max_size_file:2000000 ,type_file:'application/pdf',format_name_file:'documento.pdf'}}], true),
);