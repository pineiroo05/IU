let analysis_preparation_def_tests=Array(
    ...
    Array('analysis_preparation', 'nuevo_file_analysis_preparation', 'inputfile', 51, 'tamaño minimo nombre OK', 'EDIT', 'nuevo_alumnograduacion_min_file_name_size_KO', 'Error, el nombre no puede tener menos de 7 caracteres.'),
    Array('analysis_preparation', 'nuevo_file_analysis_preparation', 'inputfile', 52, 'tamaño maximo nombre OK', 'EDIT', 'nuevo_alumnograduacion_max_file_name_size_KO', 'Error, el nombre no puede tener mas de 100 caracteres'),
