...
let characteristic_pruebas=Array(
    ...
    Array('characteristic', 'data_type_characteristic', 47, 94, 'SEARCH', [{data_type_characteristic:'n'}], true),
    Array('characteristic', 'data_type_characteristic', 47, 95, 'SEARCH', [{data_type_characteristic:'number'}], true),

    //category_characteristic
    Array('characteristic', 'category_characteristic', 48, 96, 'ADD', [{category_charcateristic:'a'}], 'category_characteristic_min_size_KO'),
    Array('characteristic', 'category_characteristic', 49, 97, 'ADD', [{category_characteristic:'a'.repeat(10)}], 'characteristic_max_size_KO'),
    ...
    Array('characteristic', 'category_characteristic', 51, 101, 'ADD', [{category_characteristic:'Holaaaa'}], 'category_characteristic_valor_permitido_KO'),
    Array('characteristic', 'category_characteristic', 52, 102, 'ADD', [{category_characteristic:'soil_characteristic'}], true),

    Array('characteristic', 'category_characteristic', 53, 103, 'EDIT', [{category_charcateristic:'a'}], 'category_characteristic_min_size_KO'),
    Array('characteristic', 'category_characteristic', 54, 104, 'EDIT', [{category_characteristic:'a'.repeat(10)}], 'characteristic_max_size_KO'),
    ...
    Array('characteristic', 'category_characteristic', 56, 108, 'EDIT', [{category_characteristic:'Holaaaa'}], 'category_characteristic_valor_permitido_KO'),
    Array('characteristic', 'category_characteristic', 57, 109, 'EDIT', [{category_characteristic:'soil_characteristic'}], true),

    Array('characteristic', 'category_characteristic', 58, 110, 'SEARCH', [{category_characteristic:'a'.repeat(10)}], 'characteristic_max_size_KO'),
    ...
    Array('characteristic', 'category_characteristic', 60, 117, 'SEARCH', [{category_characteristic:'Holaaaa'}], 'category_characteristic_valor_permitido_KO'),
    Array('characteristic', 'category_characteristic', 61, 118, 'SEARCH', [{category_characteristic:''}], true),
    Array('characteristic', 'category_characteristic', 61, 119, 'SEARCH', [{category_characteristic:'soil'}], true),
    Array('characteristic', 'category_characteristic', 61, 120, 'SEARCH', [{category_characteristic:'soil_characteristic'}], true),

    //bibref_characteristic
    Array('characteristic', 'bibref_characteristic', 62, 121, 'ADD', [{bibref_characteristic:'a'}], 'bibref_characteristic_min_size_KO'),
    Array('characteristic', 'bibref_characteristic', 63, 122, 'ADD', [{bibref_characteristic:'a'.repeat(201)}], 'bibref_characteristic_max_size_KO'),
    Array('characteristic', 'bibref_characteristic', 64, 123, 'ADD', [{bibref_characteristic:'aaaaaaa1aaaaaaaa'}], 'bibref_characteristic_format_KO'),
    Array('characteristic', 'bibref_characteristic', 64, 124, 'ADD', [{bibref_characteristic:'aaaaaaa_aaaaaaaa'}], 'bibref_characteristic_format_KO'),
    Array('characteristic', 'bibref_characteristic', 64, 125, 'ADD', [{bibref_characteristic:'aaaaaaa-aaaaaaaa'}], 'bibref_characteristic_format_KO'),
    Array('characteristic', 'bibref_characteristic', 65, 126, 'ADD', [{bibref_characteristic:'Hola buenos días'}], true),

    Array('characteristic', 'bibref_characteristic', 66, 127, 'EDIT', [{bibref_characteristic:'a'}], 'bibref_characteristic_min_size_KO'),
    Array('characteristic', 'bibref_characteristic', 67, 128, 'EDIT', [{bibref_characteristic:'a'.repeat(201)}], 'bibref_characteristic_max_size_KO'),
    Array('characteristic', 'bibref_characteristic', 68, 129, 'EDIT', [{bibref_characteristic:'aaaaaaa1aaaaaaaa'}], 'bibref_characteristic_format_KO'),
    Array('characteristic', 'bibref_characteristic', 68, 130, 'EDIT', [{bibref_characteristic:'aaaaaaa_aaaaaaaa'}], 'bibref_characteristic_format_KO'),
    Array('characteristic', 'bibref_characteristic', 68, 131, 'EDIT', [{bibref_characteristic:'aaaaaaa-aaaaaaaa'}], 'bibref_characteristic_format_KO'),
    Array('characteristic', 'bibref_characteristic', 69, 132, 'EDIT', [{bibref_characteristic:'Hola buenos días'}], true),

    Array('characteristic', 'bibref_characteristic', 70, 133, 'SEARCH', [{bibref_characteristic:'a'.repeat(201)}], 'bibref_characteristic_max_size_KO'),
    Array('characteristic', 'bibref_characteristic', 71, 134, 'SEARCH', [{bibref_characteristic:'1'}], 'bibref_characteristic_format_KO'),
    Array('characteristic', 'bibref_characteristic', 71, 135, 'SEARCH', [{bibref_characteristic:'_'}], 'bibref_characteristic_format_KO'),
    Array('characteristic', 'bibref_characteristic', 71, 136, 'SEARCH', [{bibref_characteristic:'-'}], 'bibref_characteristic_format_KO'),
    Array('characteristic', 'bibref_characteristic', 71, 137, 'SEARCH', [{bibref_characteristic:'aaaaaaa1aaaaaaaa'}], 'bibref_characteristic_format_KO'),
    Array('characteristic', 'bibref_characteristic', 71, 138, 'SEARCH', [{bibref_characteristic:'aaaaaaa_aaaaaaaa'}], 'bibref_characteristic_format_KO'),
    Array('characteristic', 'bibref_characteristic', 71, 139, 'SEARCH', [{bibref_characteristic:'aaaaaaa-aaaaaaaa'}], 'bibref_characteristic_format_KO'),
    Array('characteristic', 'bibref_characteristic', 72, 140, 'SEARCH', [{bibref_characteristic:''}], true),
    Array('characteristic', 'bibref_characteristic', 72, 141, 'SEARCH', [{bibref_characteristic:'Ho'}], true),
    Array('characteristic', 'bibref_characteristic', 72, 142, 'SEARCH', [{bibref_characteristic:'Hola buenos días'}], true),

    //file_characteristic
    Array('characteristic', 'file_characteristic', 73, 143, 'SEARCH', [{file_characteristic:'a'.repeat(101)}], 'file_characteristic_max_size_KO'),
    ...
    Array('characteristic', 'file_characteristic', 74, 143, 'SEARCH', [{file_characteristic:'a a'}], 'file_characteristic_format_KO'),
    Array('characteristic', 'file_characteristic', 74, 143, 'SEARCH', [{file_characteristic:'documeñto.pdf'}], 'file_characteristic_format_KO'),
    Array('characteristic', 'file_characteristic', 74, 143, 'SEARCH', [{file_characteristic:'documentó.pdf'}], 'file_characteristic_format_KO'),
    Array('characteristic', 'file_characteristic', 74, 143, 'SEARCH', [{file_characteristic:'documento,pdf'}], 'file_characteristic_format_KO'),
    Array('characteristic', 'file_characteristic', 75, 143, 'SEARCH', [{file_characteristic:'d'}], true),
    Array('characteristic', 'file_characteristic', 75, 143, 'SEARCH', [{file_characteristic:'doc'}], true),
    Array('characteristic', 'file_characteristic', 75, 143, 'SEARCH', [{file_characteristic:'documento.pdf'}], true),

    //nuevo_file_characteristic
    Array('characteristic', 'nuevo_file_characteristic', 76, 131, 'ADD', [{nuevo_file_characteristic:{max_size_file:'', type_file:'', format_name_file:''}}], 'nuevo_file_characteristic_not_exist_file_KO'),
    Array('characteristic', 'nuevo_file_characteristic', 77, 132, 'ADD', [{nuevo_file_characteristic:{max_size_file: 20000000,type_file:'application/pdf', format_name_file:'documento.pdf'}}], 'nuevo_file_characteristic_max_size_file_KO'),
    Array('characteristic', 'nuevo_file_characteristic', 78, 133, 'ADD', [{nuevo_file_characteristic:{max_size_file: 2000000,type_file:'image/png', format_name_file:'imagen.png'}}], 'nuevo_file_characteristic_type_file_KO'),
    Array('characteristic', 'nuevo_file_characteristic', 79, 134, 'ADD', [{nuevo_file_characteristic:{max_size_file: 2000000,type_file:'application/pdf', format_name_file:'documentó.pdf'}}], 'nuevo_file_characteristic_format_name_file_KO'),
    ...
    Array('characteristic', 'nuevo_file_characteristic', 79, 136, 'ADD', [{nuevo_file_characteristic:{max_size_file: 2000000,type_file:'application/pdf', format_name_file:'docume nto.pdf'}}], 'nuevo_file_characteristic_format_name_file_KO'),
    ...
    Array('characteristic', 'nuevo_file_characteristic', 84, 142, 'EDIT', [{nuevo_file_characteristic:{max_size_file: 2000000,type_file:'image/png', format_name_file:'imagen.png'}}], 'nuevo_file_characteristic_type_file_KO'),
    Array('characteristic', 'nuevo_file_characteristic', 85, 143, 'EDIT', [{nuevo_file_characteristic:{max_size_file: 2000000,type_file:'application/pdf', format_name_file:'documentó.pdf'}}], 'nuevo_file_characteristic_format_name_file_KO'),
    Array('characteristic', 'nuevo_file_characteristic', 85, 144, 'EDIT', [{nuevo_file_characteristic:{max_size_file: 2000000,type_file:'application/pdf', format_name_file:'documeñto.pdf'}}], 'nuevo_file_characteristic_format_name_file_KO'),
    Array('characteristic', 'nuevo_file_characteristic', 85, 145, 'EDIT', [{nuevo_file_characteristic:{max_size_file: 2000000,type_file:'application/pdf', format_name_file:'docume nto.pdf'}}], 'nuevo_file_characteristic_format_name_file_KO'),
    Array('characteristic', 'nuevo_file_characteristic', 86, 146, 'EDIT', [{nuevo_file_characteristic:{max_size_file: 2000000,type_file:'application/pdf', format_name_file:'do.pdf'}}], 'nuevo_file_characteristic_min_file_name_size_KO'),
    Array('characteristic', 'nuevo_file_characteristic', 87, 147, 'EDIT', [{nuevo_file_characteristic:{max_size_file: 2000000,type_file:'application/pdf', format_name_file:'d'.repeat(100)+'.pdf'}}], 'nuevo_file_characteristic_max_file_name_size_KO'),
    Array('characteristic', 'nuevo_file_characteristic', 88, 148, 'EDIT', [{nuevo_file_characteristic:{max_size_file: 2000000,type_file:'application/pdf', format_name_file:'documento.pdf'}}], true),
);