...
let characteristic_pruebas=Array(
    ...
    Array('characteristic', 'bibref_characteristic', 70, 133, 'ADD', [{bibref_characteristic:'a'.repeat(201)}], 'bibref_characteristic_max_size_KO'),
    Array('characteristic', 'bibref_characteristic', 71, 134, 'ADD', [{bibref_characteristic:'1'}], 'bibref_characteristic_format_KO'),
    Array('characteristic', 'bibref_characteristic', 71, 135, 'ADD', [{bibref_characteristic:'_'}], 'bibref_characteristic_format_KO'),
    Array('characteristic', 'bibref_characteristic', 71, 136, 'ADD', [{bibref_characteristic:'-'}], 'bibref_characteristic_format_KO'),
    Array('characteristic', 'bibref_characteristic', 71, 137, 'ADD', [{bibref_characteristic:'aaaaaaa1aaaaaaaa'}], 'bibref_characteristic_format_KO'),
    Array('characteristic', 'bibref_characteristic', 71, 138, 'ADD', [{bibref_characteristic:'aaaaaaa_aaaaaaaa'}], 'bibref_characteristic_format_KO'),
    Array('characteristic', 'bibref_characteristic', 71, 139, 'ADD', [{bibref_characteristic:'aaaaaaa-aaaaaaaa'}], 'bibref_characteristic_format_KO'),
    Array('characteristic', 'bibref_characteristic', 72, 140, 'ADD', [{bibref_characteristic:''}], true),
    Array('characteristic', 'bibref_characteristic', 72, 141, 'ADD', [{bibref_characteristic:'Ho'}], true),
    Array('characteristic', 'bibref_characteristic', 72, 142, 'ADD', [{bibref_characteristic:'Hola buenos días'}], true),
    ...
    Array('characteristic', 'nuevo_file_characteristic', 78, 133, 'ADD', [{nuevo_file_characteristic:{max_size_file: 2000000,type_file:'image/png', format_name_file:'documento.pdf'}}], 'nuevo_file_characteristic_type_file_KO'),
    ...
    Array('characteristic', 'nuevo_file_characteristic', 84, 142, 'EDIT', [{nuevo_file_characteristic:{max_size_file: 2000000,type_file:'image/png', format_name_file:'documento.pdf'}}], 'nuevo_file_characteristic_type_file_KO'),
    ...
    Array('characteristic', 'nuevo_file_characteristic', 85, 145, 'EDIT', [{nuevo_file_characteristic:{max_size_file: 2000000,type_file:'application/pdf', format_name_file:'docume nto.pdf'}}], 'nuevo_file_characteristic_format_name_file_file_KO'),
