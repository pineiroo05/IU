class persona extends Validations{
	...
	ADD_nuevo_foto_persona_validation(){
		if(!(this.not_exist_file('nuevo_foto_persona'))){
			this.dom.mostrar_error_campo('nuevo_foto_persona', 'foto_persona_empty_file_KO');
			return "foto_persona_empty_file_KO";
		}
		if(!(this.max_size_file('nuevo_foto_persona', 2000000))){
			...
			return "foto_persona_max_size_file_KO";
		}
		if(!(this.type_file('nuevo_foto_persona', ['image/jpeg']))){
			...
			return "foto_persona_type_file_KO";
		}
		if(!(this.format_name_file('nuevo_foto_persona', '[a-zA-Z.]'))){
			this.dom.mostrar_error_campo('nuevo_foto_persona', 'nuevo_foto_persona_name_file_KO');
			return "fnuevo_foto_persona_name_file_KO";
		}
	...
	*/
	...
	ADD_submit_persona(){
		let result = ((this.ADD_dni_validation()) && (this.ADD_nombre_persona_validation()) && (this.ADD_apellidos_persona_validation()) && (this.ADD_fechaNacimiento_persona_validation()) && (this.ADD_telefono_persona_validation()) && (this.ADD_email_persona_validation()) & (this.ADD_nuevo_foto_persona_validation()))
