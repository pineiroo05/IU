class persona extends Validations{
	...
	*/
	...
	ADD_submit_persona(){
		let result = ((this.ADD_dni_validation()) & (this.ADD_nombre_persona_validation()) & (this.ADD_apellidos_persona_validation()) & (this.ADD_fechaNacimiento_persona_validation()) & (this.ADD_telefono_persona_validation()) & (this.ADD_email_persona_validation()))
