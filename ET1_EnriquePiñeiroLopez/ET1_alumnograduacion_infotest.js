    let alumnograduacion_def_tests=Array(
        ...
        Array('alumnograduacion', 'alumnograduacion_titulacion', 1, 'tamaño inferior a 3 caracteres', 'ADD', false, 'Las titulaciones de la esei tienen como minimo 3 caracteres alfabeticos'),
        Array('alumnograduacion', 'alumnograduacion_titulacion', 2, 'tamaño superior a 4 caracteres', 'ADD', false, 'Las titulaciones de la esei tienen como maximo 4 caracteres alfabeticos'),
        
        Array('alumnograduacion', 'alumnograduacion_titulacion', 1, 'valor distinto a grei, gria, mei, mia, pceo', 'ADD', false, 'Titulacion invalida. Solo tenemos GREI, GRIA, MEI, MIA o PCEO'),
        Array('alumnograduacion', 'alumnograduacion_titulacion', 2, 'longitud y valor correctos', 'ADD', true, 'Valor correcto'),
        ...
        Array('alumnograduacion', 'alumnograduacion_fotoacto', 6, 'longitud entre 7 y 100, tamaño correcto, y formato y tipo de fichero corrctos', 'ADD', true, 'Fichero correcto'),
