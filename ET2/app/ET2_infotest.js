...
let articulo_tests_fields=Array(
    ...
    //AutoresA
    Array('articulo', 'AutoresA', 12, 19, 'ADD', [{AutoresA:'a'.repeat(3)}], 'AutoresA_min_size_KO'),
    ...
    Array('articulo', 'AutoresA', 14, 24, 'ADD', [{AutoresA:21}], 'AutoresA_format_KO'),
    Array('articulo', 'AutoresA', 15, 25, 'ADD', [{AutoresA:'Pepito Fulanito'}], true),

    Array('articulo', 'AutoresA', 16, 19, 'EDIT', [{AutoresA:'a'.repeat(3)}], 'AutoresA_min_size_KO'),
    ...
    Array('articulo', 'AutoresA', 18, 24, 'EDIT', [{AutoresA:21}], 'AutoresA_format_KO'),
    ...
    //TituloA
    Array('articulo', 'TituloA', 23, 31, 'ADD', [{TituloA:'a'.repeat(8)}], 'TituloA_min_size_KO'),
    Array('articulo', 'TituloA', 24, 32, 'ADD', [{TituloA:'a'.repeat(101)}], 'TituloA_max_size_KO'),
    Array('articulo', 'TituloA', 25, 33, 'ADD', [{TituloA:'a-b'}], 'TituloA_format_KO'),
    Array('articulo', 'TituloA', 25, 34, 'ADD', [{TituloA:'a_b'}], 'TituloA_format_KO'),
    Array('articulo', 'TituloA', 25, 35, 'ADD', [{TituloA:'a ç'}], 'TituloA_format_KO'),
    Array('articulo', 'TituloA', 26, 36, 'ADD', [{TituloA:'Titulo del articulo 2'}], true),

    Array('articulo', 'TituloA', 27, 37, 'EDIT', [{TituloA:'a'.repeat(8)}], 'TituloA_min_size_KO'),
    Array('articulo', 'TituloA', 28, 38, 'EDIT', [{TituloA:'a'.repeat(101)}], 'TituloA_max_size_KO'),
    Array('articulo', 'TituloA', 29, 39, 'EDIT', [{TituloA:'a-b'}], 'TituloA_format_KO'),
    Array('articulo', 'TituloA', 29, 40, 'EDIT', [{TituloA:'a_b'}], 'TituloA_format_KO'),
    Array('articulo', 'TituloA', 29, 41, 'EDIT', [{TituloA:'a ç'}], 'TituloA_format_KO'),
    ...
    Array('articulo', 'TituloR', 36, 52, 'ADD', [{TituloR:'a-b'}], 'TituloR_format_KO'),
    Array('articulo', 'TituloR', 36, 53, 'ADD', [{TituloR:'a_b'}], 'TituloR_format_KO'),
    Array('articulo', 'TituloR', 36, 54, 'ADD', [{TituloR:'a ç'}], 'TituloR_format_KO'),
    ...
    Array('articulo', 'TituloR', 40, 59, 'EDIT', [{TituloR:'a-b'}], 'TituloR_format_KO'),
    Array('articulo', 'TituloR', 40, 60, 'EDIT', [{TituloR:'a_b'}], 'TituloR_format_KO'),
    Array('articulo', 'TituloR', 40, 61, 'EDIT', [{TituloR:'a ç'}], 'TituloR_format_KO'),
    ...
    Array('articulo', 'TituloR', 43, 64, 'SEARCH', [{TituloR:'-'}], 'TituloA_format_KO'),
    Array('articulo', 'TituloR', 43, 65, 'SEARCH', [{TituloR:'_'}], 'TituloA_format_KO'),
    Array('articulo', 'TituloR', 43, 66, 'SEARCH', [{TituloR:'a-b'}], 'TituloA_format_KO'),
    Array('articulo', 'TituloR', 43, 67, 'SEARCH', [{TituloR:'a_b'}], 'TituloA_format_KO'),
    Array('articulo', 'TituloR', 43, 68, 'SEARCH', [{TituloR:'a ç'}], 'TituloA_format_KO'),
    ...
    Array('articulo', 'ISSN', 55, 87, 'EDIT', [{ISSN:'1'.repeat(10)}], 'ISSN_max_size_KO'),
    Array('articulo', 'ISSN', 56, 88, 'EDIT', [{ISSN:'_'}], 'ISSN_format_KO'),
    Array('articulo', 'ISSN', 56, 89, 'EDIT', [{ISSN:'$'}], 'ISSN_format_KO'),
    Array('articulo', 'ISSN', 56, 90, 'EDIT', [{ISSN:'/'}], 'ISSN_format_KO'),
    Array('articulo', 'ISSN', 56, 91, 'EDIT', [{ISSN:'1111_1111'}], 'ISSN_format_KO'),
    Array('articulo', 'ISSN', 56, 92, 'EDIT', [{ISSN:'1111$1111'}], 'ISSN_format_KO'),
    Array('articulo', 'ISSN', 56, 93, 'EDIT', [{ISSN:'1111/1111'}], 'ISSN_format_KO'),
    Array('articulo', 'ISSN', 57, 94, 'EDIT', [{ISSN:'0000-000X'}], 'ISSN_valor_valido_KO'),
    Array('articulo', 'ISSN', 58, 95, 'EDIT', [{ISSN:''}], true), 
    Array('articulo', 'ISSN', 58, 96, 'EDIT', [{ISSN:'000'}], true), 
    Array('articulo', 'ISSN', 58, 97, 'EDIT', [{ISSN:'0000-0000'}], true), 
    ...
    Array('articulo', 'PagIniA', 73, 127, 'ADD', [{PagIniA:'-111'}], 'PagIniA_format_KO'),
    Array('articulo', 'PagIniA', 73, 128, 'ADD', [{PagIniA:'1_11'}], 'PagIniA_format_KO'),
    Array('articulo', 'PagIniA', 73, 129, 'ADD', [{PagIniA:'11$1'}], 'PagIniA_format_KO'),
    ...
    Array('articulo', 'PagIniA', 78, 137, 'EDIT', [{PagIniA:'-111'}], 'PagIniA_format_KO'),
    Array('articulo', 'PagIniA', 78, 138, 'EDIT', [{PagIniA:'1_11'}], 'PagIniA_format_KO'),
    Array('articulo', 'PagIniA', 78, 139, 'EDIT', [{PagIniA:'11$1'}], 'PagIniA_format_KO'),
    ...
    Array('articulo', 'PagIniA', 82, 149, 'SEARCH', [{PagIniA:'-111'}], 'PagIniA_format_KO'),
    Array('articulo', 'PagIniA', 82, 150, 'SEARCH', [{PagIniA:'1_11'}], 'PagIniA_format_KO'),
    Array('articulo', 'PagIniA', 82, 151, 'SEARCH', [{PagIniA:'11$1'}], 'PagIniA_format_KO'),
    ...
    Array('articulo', 'PagFinA', 87, 159, 'ADD', [{PagFinA:'-111'}], 'PagFinA_format_KO'),
    ...
    Array('articulo', 'PagFinA', 93, 170, 'EDIT', [{PagFinA:'-111'}], 'PagFinA_format_KO'),
    ...
    Array('articulo', 'PagFinA', 98, 184, 'SEARCH', [{PagFinA:'-111'}], 'PagFinA_format_KO'),
...
let ubicacion_tests_fields=Array(
    ...
    Array('ubicacion', 'site_longitud', 24, 35, 'ADD', [{site_longitud:'90.999999'}], 'site_longitud_formato_rango_KO'),
    Array('ubicacion', 'site_longitud', 24, 36, 'ADD', [{site_longitud:'91'}], 'site_longitud_formato_rango_KO'),
    Array('ubicacion', 'site_longitud', 24, 37, 'ADD', [{site_longitud:'-90.999999'}], 'site_longitud_formato_rango_KO'),
    Array('ubicacion', 'site_longitud', 24, 38, 'ADD', [{site_longitud:'-91'}], 'site_longitud_formato_rango_KO'),
    ...
    Array('ubicacion', 'site_longitud', 28, 42, 'EDIT', [{site_longitud:'90.999999'}], 'site_longitud_formato_rango_KO'),
    Array('ubicacion', 'site_longitud', 28, 43, 'EDIT', [{site_longitud:'91'}], 'site_longitud_formato_rango_KO'),
    Array('ubicacion', 'site_longitud', 28, 44, 'EDIT', [{site_longitud:'-90.999999'}], 'site_longitud_formato_rango_KO'),
    Array('ubicacion', 'site_longitud', 28, 45, 'EDIT', [{site_longitud:'-91'}], 'site_longitud_formato_rango_KO'),
    ...
    Array('ubicacion', 'site_longitud', 31, 48, 'SEARCH', [{site_longitud:'90.999999'}], 'site_longitud_formato_rango_KO'),
    Array('ubicacion', 'site_longitud', 31, 49, 'SEARCH', [{site_longitud:'91'}], 'site_longitud_formato_rango_KO'),
    Array('ubicacion', 'site_longitud', 31, 50, 'SEARCH', [{site_longitud:'-90.999999'}], 'site_longitud_formato_rango_KO'),
    Array('ubicacion', 'site_longitud', 31, 51, 'SEARCH', [{site_longitud:'-91'}], 'site_longitud_formato_rango_KO'),
    ...
    Array('ubicacion', 'site_provider_login', 54, 91, 'ADD', [{site_provider_login:'a'.repeat(31)}], 'site_provider_max_size_KO'),
    Array('ubicacion', 'site_provider_login', 55, 92, 'ADD', [{site_provider_login:'aaa.'}], 'site_provider_login_format'),
    Array('ubicacion', 'site_provider_login', 55, 93, 'ADD', [{site_provider_login:'.aaa'}], 'site_provider_login_format'),
    Array('ubicacion', 'site_provider_login', 55, 94, 'ADD', [{site_provider_login:'aaa,'}], 'site_provider_login_format'),
    Array('ubicacion', 'site_provider_login', 55, 95, 'ADD', [{site_provider_login:',aaa'}], 'site_provider_login_format'),
    Array('ubicacion', 'site_provider_login', 55, 96, 'ADD', [{site_provider_login:'aaa$'}], 'site_provider_login_format'),
    Array('ubicacion', 'site_provider_login', 55, 97, 'ADD', [{site_provider_login:'$aaa'}], 'site_provider_login_format'),
    Array('ubicacion', 'site_provider_login', 55, 98, 'ADD', [{site_provider_login:'aaa a'}], 'site_provider_login_format'),
    ...
    Array('ubicacion', 'site_provider_login', 58, 101, 'EDIT', [{site_provider_login:'a'.repeat(31)}], 'site_provider_max_size_KO'),
    Array('ubicacion', 'site_provider_login', 59, 102, 'EDIT', [{site_provider_login:'aaa.'}], 'site_provider_login_format'),
    Array('ubicacion', 'site_provider_login', 59, 103, 'EDIT', [{site_provider_login:'.aaa'}], 'site_provider_login_format'),
    Array('ubicacion', 'site_provider_login', 59, 104, 'EDIT', [{site_provider_login:'aaa,'}], 'site_provider_login_format'),
    Array('ubicacion', 'site_provider_login', 59, 105, 'EDIT', [{site_provider_login:',aaa'}], 'site_provider_login_format'),
    Array('ubicacion', 'site_provider_login', 59, 106, 'EDIT', [{site_provider_login:'aaa$'}], 'site_provider_login_format'),
    Array('ubicacion', 'site_provider_login', 59, 107, 'EDIT', [{site_provider_login:'$aaa'}], 'site_provider_login_format'),
    Array('ubicacion', 'site_provider_login', 59, 108, 'EDIT', [{site_provider_login:'aaa a'}], 'site_provider_login_format'),
    Array('ubicacion', 'site_provider_login', 60, 109, 'EDIT', [{site_provider_login:'enrique_pl05'}], true),

    Array('ubicacion', 'site_provider_login', 61, 110, 'SEARCH', [{site_provider_login:'a'.repeat(31)}], 'site_provider_max_size_KO'),
    Array('ubicacion', 'site_provider_login', 62, 111, 'SEARCH', [{site_provider_login:'.'}], 'site_provider_login_format'),
    Array('ubicacion', 'site_provider_login', 62, 112, 'SEARCH', [{site_provider_login:','}], 'site_provider_login_format'),
    Array('ubicacion', 'site_provider_login', 62, 113, 'SEARCH', [{site_provider_login:'$'}], 'site_provider_login_format'),
    Array('ubicacion', 'site_provider_login', 62, 114, 'SEARCH', [{site_provider_login:'aaa.'}], 'site_provider_login_format'),
    Array('ubicacion', 'site_provider_login', 62, 115, 'SEARCH', [{site_provider_login:'.aaa'}], 'site_provider_login_format'),
    Array('ubicacion', 'site_provider_login', 62, 116, 'SEARCH', [{site_provider_login:'aaa,'}], 'site_provider_login_format'),
    Array('ubicacion', 'site_provider_login', 62, 117, 'SEARCH', [{site_provider_login:',aaa'}], 'site_provider_login_format'),
    Array('ubicacion', 'site_provider_login', 62, 118, 'SEARCH', [{site_provider_login:'aaa$'}], 'site_provider_login_format'),
    Array('ubicacion', 'site_provider_login', 62, 119, 'SEARCH', [{site_provider_login:'$aaa'}], 'site_provider_login_format'),
    Array('ubicacion', 'site_provider_login', 62, 120, 'SEARCH', [{site_provider_login:'aaa a'}], 'site_provider_login_format'),
