let alumnograduacion_def_tests=Array(
    ...
    Array('alumnograduacion', 'alumnograduacion_fotoacto', 'inputfile', 107, 'nombre OK', 'ADD', 'nuevo_alumnograduacion_fotoacto_format_name_file_KO', 'El nombre no es valido, solo se aceptan nombres de entre 7 y 100 caracteres, sin ñ acentos ni espacios.'),
    Array('alumnograduacion', 'alumnograduacion_fotoacto', 'inputfile', 108, 'todo correcto', 'ADD', true, 'Fichero correcto'),
    
    Array('alumnograduacion', 'alumnograduacion_fotoacto', 'inputfile', 109, 'tamaño maximo OK', 'EDIT', 'nuevo_alumnograduacion_fotoacto_max_size_file_KO', 'El archivo no puede tener mas de 20MB'),
    Array('alumnograduacion', 'alumnograduacion_fotoacto', 'inputfile', 110, 'tipo fichero OK', 'EDIT', 'nuevo_alumnograduacion_fotoacto_type_file_KO', 'El tipo de archivo no es valido, solo puedes meter jpg'),
    Array('alumnograduacion', 'alumnograduacion_fotoacto', 'inputfile', 111, 'nombre OK', 'EDIT', 'nuevo_alumnograduacion_fotoacto_format_name_file_KO', 'El nombre no es valido, solo se aceptan nombres de entre 7 y 100 caracteres, sin ñ acentos ni espacios.'),
...
let alumnograduacion_tests_files=Array(
    ...
    Array('alumnograduacion', 'nuevo_alumnograduacion_fotoacto', 108, 7, 'ADD', 'todo correcto', [{format_name_file:'nombre.jpg'}, {type_file:'image/jpeg'}, {max_size_file:2000000}], true),
    
    Array('alumnograduacion', 'nuevo_alumnograduacion_fotoacto', 109, 8, 'EDIT', 'tamaño maximo OK', [{format_name_file:'nombre.jpg'}, {type_file:'image/jpeg'}, {max_size_file:20000000}], 'nuevo_alumnograduacion_fotoacto_max_size_file_KO'),
    Array('alumnograduacion', 'nuevo_alumnograduacion_fotoacto', 110, 9, 'EDIT', 'tipo fichero OK', [{format_name_file:'nombre.jpg'}, {type_file:'image/png'}, {max_size_file:2000000}], 'nuevo_alumnograduacion_fotoacto_type_file_KO'),
    Array('alumnograduacion', 'nuevo_alumnograduacion_fotoacto', 111, 10, 'EDIT', 'nombre OK', [{format_name_file:'ñombre.jpg'}, {type_file:'image/jpeg'}, {max_size_file:2000000}], 'nuevo_alumnograduacion_fotoacto_format_name_file_KO'),
